  ...
  return (
    <div className="dictionary-contents">
      <div className="word-info">
        ...
        <button disabled={!wordAudioSrc} onClick={() => audio.play()}>
          ...
          <>
            ...
            {x.synonyms.length !== 0 && (
              <div className="meanings-synonyms">
                <span>Synonyms</span>
                {x.synonyms.map((y, i) => (
                  <button key={i} className="synonyms-btn" onClick={() => setCurrentWord(y)}>
                    {y}
                  </button>
                ))}
              </div>
            ...
            {x.antonyms.length !== 0 && (
              <div className="meanings-antonyms">
                <span>Antonyms</span>
                {x.antonyms.map((y, i) => (
                  <button key={i} className="antonyms-btn" onClick={() => setCurrentWord(y)}>
                    {y}
                  </button>
                ))}
              </div>
